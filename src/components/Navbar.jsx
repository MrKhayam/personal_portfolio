    ...
    <>
      <div className="md:w-[90%] w-[95%] mx-auto mt-3 md:mt-5 text-white md:h-[50px] bg-transparent flex items-center justify-between font-['Poppins']">
        ...
        <div className="menu md:hidden">
          ...
          <div className={`w-full overflow-x-hidden transition-all duration-300 h-screen md:hidden fixed flex flex-col items-center ${!isNav ? 'translate-x-[100%]' : 'translate-x-0'} bg-black z-20 top-0 `}>
