...
const AboutHero = () => {
  return (
    <>
      <div className="text-white md:w-[90%] md:p-0 p-3 gap-3 w-[95%] mx-auto md:mt-[16vh] justify-center items-center md:items-start mt-24 md:gap-5 flex flex-col">
        <h1 className='md:text-8xl text-5xl font-["Charley"] text-center'>About Me</h1>
        <h2 className='md:text-3xl text-center text-lg font-light md:w-[70vw]'>
